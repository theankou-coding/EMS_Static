...
const ContactUsAlt = () => {
  ...
  return (
    <main
      className="min-h-screen py-24 px-6 lg:px-16 text-gray-200 relative overflow-hidden"
      style={{
        background: `linear-gradient(135deg, #081c33 0%, #15355b 100%)`,
      }}
    >
      {/* Optional blurred overlay for depth */}
      <div
        aria-hidden="true"
      ...
      <section className="relative max-w-3xl mx-auto bg-white bg-opacity-10 backdrop-blur-md rounded-3xl shadow-lg px-12 py-16">
